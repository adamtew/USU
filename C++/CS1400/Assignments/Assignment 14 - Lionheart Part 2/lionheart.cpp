...
Unit * newUnit(string tla, Rank rank){
	...
	if(tla=="ACC")return new ACC(0,0,hp,up,rank,false,tla);
  ...
  /*if(tla=="xxy")return new Unit(0,0,hp,up,rank,false,tla);
	...
	if(tla=="JUA")return new JUA(0,0,hp,up,rank,false,tla);
	if(tla=="JDG")return new JDG(0,0,hp,up,rank,false,tla);
	if(tla=="ACC")return new ACC(0,0,hp,up,rank,false,tla);
	if(tla=="TEN")return new TEN(0,0,hp,up,rank,false,tla);
	if(tla=="TSP")return new TSP(0,0,hp,up,rank,false,tla);
	if(tla=="VAP")return new VAP(0,0,hp,up,rank,false,tla);
	if(tla=="AHA")return new AHA(0,0,hp,up,rank,false,tla);
	if(tla=="HJB")return new HJB(0,0,hp,up,rank,false,tla);
	if(tla=="JWA")return new JWA(0,0,hp,up,rank,false,tla);
	if(tla=="NRR")return new NRR(0,0,hp,up,rank,false,tla);
	if(tla=="SCC")return new SCC(0,0,hp,up,rank,false,tla);
	if(tla=="BBQ")return new BBQ(0,0,hp,up,rank,false,tla);
	if(tla=="DWS")return new DWS(0,0,hp,up,rank,false,tla);
	if(tla=="VAN")return new VAN(0,0,hp,up,rank,false,tla);
	if(tla=="TAG")return new TAG(0,0,hp,up,rank,false,tla);
	if(tla=="ZRT")return new ZRT(0,0,hp,up,rank,false,tla);
	if(tla=="RBH")return new RBH(0,0,hp,up,rank,false,tla);
	if(tla=="TRD")return new TRD(0,0,hp,up,rank,false,tla);
	if(tla=="TGN")return new TGN(0,0,hp,up,rank,false,tla);
	if(tla=="DAT")return new DAT(0,0,hp,up,rank,false,tla);*/
